...
##### [E-Hentai Downloader](https://github.com/XYZephyrus/ZEUS/raw/refs/heads/main/script-ehentai%20downloader.user.js) / [Original](https://openuserjs.org/scripts/zsyjklive.cn/ComicLooms#operates) [Source](https://github.com/MapoMagpie/eh-view-enhance)
This Userscript enables quick and convenient browsing of galleries or artists' homepage on a [certain site](https://e-hentai.org), with batch download support, focusing on browsing experience and low site load.
...
Fix the floating header in [Fapello](https://fapello.com) that's usually happening when using an adblocker.
